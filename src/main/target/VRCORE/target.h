...
#define USART2_APB2_PERIPHERALS RCC_APB1Periph_USART2
#define USART2_AHB1_PERIPHERALS RCC_AHB1Periph_GPIOC
...
#define INVERTER
#define INVERTER_PIN Pin_7 // PC0 used as inverter select GPIO
#define INVERTER_GPIO GPIOD
#define INVERTER_PERIPHERAL RCC_AHB1Periph_GPIOD
